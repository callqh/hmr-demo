import type { InputOption, InternalModuleFormat, ModuleFormat, OutputOptions, Plugin, RollupOptions, RollupOutput, RollupWarning, RollupWatcher, WarningHandler, WatcherOptions } from 'rollup';
...
export declare function resolveBuildOptions(raw: BuildOptions | undefined, isBuild: boolean, logger: Logger): ResolvedBuildOptions;
...
declare type JsExt = 'js' | 'cjs' | 'mjs';
export declare function resolveLibFilename(libOptions: LibraryOptions, format: ModuleFormat, entryName: string, root: string, extension?: JsExt): string;
