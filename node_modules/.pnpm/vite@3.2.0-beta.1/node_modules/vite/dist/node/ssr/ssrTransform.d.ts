...
export declare function ssrTransform(code: string, inMap: SourceMap | null, url: string, originalCode: string, options?: TransformOptions): Promise<TransformResult | null>;
export {};
