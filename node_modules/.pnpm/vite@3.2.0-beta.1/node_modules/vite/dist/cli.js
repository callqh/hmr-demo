...
import { u as createLogger, e as resolveConfig } from './config-267478b1.js';
...
cli
    ...
    // is ok here
    const { createServer } = await import('./config-267478b1.js').then(function (n) { return n.A; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    const { build } = await import('./config-267478b1.js').then(function (n) { return n.z; });
...
cli
    ...
    .option('--force', `[boolean] force the optimizer to ignore the cache and re-bundle`)
    .action(async (root, options) => {
    const { optimizeDeps } = await import('./config-267478b1.js').then(function (n) { return n.y; });
    try {
...
cli
    ...
    .option('--open [path]', `[boolean | string] open browser on startup`)
    .action(async (root, options) => {
    const { preview } = await import('./config-267478b1.js').then(function (n) { return n.B; });
    try {
